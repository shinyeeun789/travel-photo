            ...
            <div className="outcome-preview-row">
              <div className="journey-preview">
                ...
                >
                  ...
                  <g className="journey-preview-pin">
                    ...
                    <circle cx="24" cy="60" r="3.2" className="journey-preview-pin-core" />
                  </g>
                  <g className="journey-preview-pin">
                    <circle cx="140" cy="40" r="9" />
                    <circle cx="140" cy="40" r="3.2" className="journey-preview-pin-core" />
                  </g>
                  <g className="journey-preview-pin">
                    <circle cx="240" cy="24" r="9" />
                    <circle cx="240" cy="24" r="3.2" className="journey-preview-pin-core" />
                  </g>
                  <g className="journey-preview-pin journey-preview-pin--final">
                    <circle cx="356" cy="52" r="11" />
                    <text x="356" y="56" textAnchor="middle" fontSize="11">
                      📸
                    </text>
                  </g>
                </svg>
              ...
              <div className="ticket-preview">
                <div className="ticket-preview-card">
                  <div className="ticket-preview-photo" aria-hidden="true">
                    🏖️
                  </div>
                  <div className="ticket-preview-info">
                    <span className="ticket-preview-title">제주도 여행</span>
                    <span className="ticket-preview-date">
                      2024.11.01 – 11.04
                    </span>
                  </div>
                  <div className="ticket-preview-stub" aria-hidden="true">
                    <span className="ticket-preview-stub-icon">✈️</span>
                  </div>
                </div>
